...
* [Netty in Action](https://www.manning.com/books/netty-in-action) - *The* book about [Netty](https://github.com/netty/netty) ⭐ 35,039 | 🐛 664 | 🌐 Java | 📅 2026-08-19, which inspired the creation of NIO
...
* [AsyncHTTPClient](https://github.com/swift-server/async-http-client) ⭐ 1,075 | 🐛 130 | 🌐 Swift | 📅 2026-07-28 - HTTP client library built on SwiftNIO
...
* [Proxyman](https://github.com/ProxymanApp/Proxyman) ⭐ 6,948 | 🐛 1,867 | 📅 2026-08-12 - HTTP Debugging Proxy, uses SwiftNIO for networking
