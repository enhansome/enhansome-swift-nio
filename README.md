...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,812 | 🐛 100 | 📅 2026-06-30
...
If you instead want to get started contributing to NIO itself, check out the list of ["good first issues"](https://github.com/apple/swift-nio/labels/good%20first%20issue) ⭐ 8,507 | 🐛 288 | 🌐 Swift | 📅 2026-08-13
...
* [Netty in Action](https://www.manning.com/books/netty-in-action) - *The* book about [Netty](https://github.com/netty/netty) ⭐ 35,033 | 🐛 660 | 🌐 Java | 📅 2026-08-17, which inspired the creation of NIO
...
* [Vapor](https://github.com/vapor/vapor) ⭐ 26,191 | 🐛 115 | 🌐 Swift | 📅 2026-08-17 - A server-side Swift web framework
...
* [Proxyman](https://github.com/ProxymanApp/Proxyman) ⭐ 6,945 | 🐛 1,865 | 📅 2026-08-12 - HTTP Debugging Proxy, uses SwiftNIO for networking
