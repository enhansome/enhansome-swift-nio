...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,831 | 🐛 107 | 📅 2026-09-02
...
If you instead want to get started contributing to NIO itself, check out the list of ["good first issues"](https://github.com/apple/swift-nio/labels/good%20first%20issue) ⭐ 8,525 | 🐛 298 | 🌐 Swift | 📅 2026-09-26
...
* [Netty in Action](https://www.manning.com/books/netty-in-action) - *The* book about [Netty](https://github.com/netty/netty) ⭐ 35,065 | 🐛 728 | 🌐 Java | 📅 2026-09-26, which inspired the creation of NIO

## Videos

* [SwiftNIO and Network.framework](https://youtu.be/M9kEtkhEjQ8) - Showcases how to use [NIO transport services](https://github.com/apple/swift-nio-transport-services) ⭐ 341 | 🐛 24 | 🌐 Swift | 📅 2026-09-25 to build an iOS SMTP client
...
* [Vapor](https://github.com/vapor/vapor) ⭐ 26,222 | 🐛 83 | 🌐 Swift | 📅 2026-09-25 - A server-side Swift web framework
...
* [Proxyman](https://github.com/ProxymanApp/Proxyman) ⭐ 6,991 | 🐛 1,898 | 📅 2026-09-21 - HTTP Debugging Proxy, uses SwiftNIO for networking

### Examples

* [Swift NIO Examples](https://github.com/apple/swift-nio-examples) ⭐ 254 | 🐛 16 | 🌐 Swift | 📅 2026-09-25 - A set of NIO examples
