...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,075 | 🐛 106 | 📅 2026-09-02
...
If you instead want to get started contributing to NIO itself, check out the list of ["good first issues"](https://github.com/apple/swift-nio/labels/good%20first%20issue) ⭐ 8,521 | 🐛 292 | 🌐 Swift | 📅 2026-09-17
...
* [Netty in Action](https://www.manning.com/books/netty-in-action) - *The* book about [Netty](https://github.com/netty/netty) ⭐ 35,062 | 🐛 674 | 🌐 Java | 📅 2026-09-17, which inspired the creation of NIO
...
* [Vapor](https://github.com/vapor/vapor) ⭐ 26,201 | 🐛 85 | 🌐 Swift | 📅 2026-09-17 - A server-side Swift web framework
...
* [Swift AWS Lambda Runtime](https://github.com/swift-server/swift-aws-lambda-runtime) ⭐ 1,233 | 🐛 8 | 🌐 Swift | 📅 2026-09-15 - Swift implementation of AWS Lambda Runtime
...
* [Swift NIO Extras](https://github.com/apple/swift-nio-extras) ⭐ 250 | 🐛 25 | 🌐 Swift | 📅 2026-09-09 - Useful code around SwiftNIO
...
* [Proxyman](https://github.com/ProxymanApp/Proxyman) ⭐ 6,976 | 🐛 1,893 | 📅 2026-09-07 - HTTP Debugging Proxy, uses SwiftNIO for networking

### Examples

* [Swift NIO Examples](https://github.com/apple/swift-nio-examples) ⭐ 255 | 🐛 15 | 🌐 Swift | 📅 2026-03-02 - A set of NIO examples
