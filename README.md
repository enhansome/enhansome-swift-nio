...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,663 | 🐛 106 | 📅 2026-09-02
...
If you instead want to get started contributing to NIO itself, check out the list of ["good first issues"](https://github.com/apple/swift-nio/labels/good%20first%20issue) ⭐ 8,519 | 🐛 294 | 🌐 Swift | 📅 2026-09-15
...
* [Netty in Action](https://www.manning.com/books/netty-in-action) - *The* book about [Netty](https://github.com/netty/netty) ⭐ 35,060 | 🐛 678 | 🌐 Java | 📅 2026-09-16, which inspired the creation of NIO
...
* [Vapor](https://github.com/vapor/vapor) ⭐ 26,194 | 🐛 83 | 🌐 Swift | 📅 2026-09-16 - A server-side Swift web framework
...
* [Swift AWS Lambda Runtime](https://github.com/swift-server/swift-aws-lambda-runtime) ⭐ 1,234 | 🐛 8 | 🌐 Swift | 📅 2026-09-15 - Swift implementation of AWS Lambda Runtime
* [AsyncHTTPClient](https://github.com/swift-server/async-http-client) ⭐ 1,076 | 🐛 138 | 🌐 Swift | 📅 2026-09-01 - HTTP client library built on SwiftNIO
...
* [Swift NIO Extras](https://github.com/apple/swift-nio-extras) ⭐ 251 | 🐛 25 | 🌐 Swift | 📅 2026-09-09 - Useful code around SwiftNIO
...
* [Proxyman](https://github.com/ProxymanApp/Proxyman) ⭐ 6,976 | 🐛 1,887 | 📅 2026-09-07 - HTTP Debugging Proxy, uses SwiftNIO for networking
