...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,363 | 🐛 100 | 📅 2026-06-30
...
If you instead want to get started contributing to NIO itself, check out the list of ["good first issues"](https://github.com/apple/swift-nio/labels/good%20first%20issue) ⭐ 8,507 | 🐛 287 | 🌐 Swift | 📅 2026-08-13
...
* [Netty in Action](https://www.manning.com/books/netty-in-action) - *The* book about [Netty](https://github.com/netty/netty) ⭐ 35,031 | 🐛 661 | 🌐 Java | 📅 2026-08-16, which inspired the creation of NIO
...
* [Vapor](https://github.com/vapor/vapor) ⭐ 26,190 | 🐛 116 | 🌐 Swift | 📅 2026-08-12 - A server-side Swift web framework
...
* [Proxyman](https://github.com/ProxymanApp/Proxyman) ⭐ 6,941 | 🐛 1,865 | 📅 2026-08-12 - HTTP Debugging Proxy, uses SwiftNIO for networking
