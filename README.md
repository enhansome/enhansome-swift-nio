...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,181 | 🐛 106 | 📅 2026-09-02
...
If you instead want to get started contributing to NIO itself, check out the list of ["good first issues"](https://github.com/apple/swift-nio/labels/good%20first%20issue) ⭐ 8,516 | 🐛 295 | 🌐 Swift | 📅 2026-09-08
...
* [Netty in Action](https://www.manning.com/books/netty-in-action) - *The* book about [Netty](https://github.com/netty/netty) ⭐ 35,046 | 🐛 668 | 🌐 Java | 📅 2026-09-08, which inspired the creation of NIO
...
* [Vapor](https://github.com/vapor/vapor) ⭐ 26,191 | 🐛 105 | 🌐 Swift | 📅 2026-09-08 - A server-side Swift web framework
...
* [Proxyman](https://github.com/ProxymanApp/Proxyman) ⭐ 6,964 | 🐛 1,882 | 📅 2026-09-07 - HTTP Debugging Proxy, uses SwiftNIO for networking
